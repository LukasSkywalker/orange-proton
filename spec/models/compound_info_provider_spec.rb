...
describe CompoundInfoProvider do
  before(:each) do
    ...
    @field1 = FieldEntry.new(0.75, 85)
    @field2 = FieldEntry.new(0.6000000000000001, 85)
    @field3 = FieldEntry.new(0.75, 113)
    @field4 = FieldEntry.new(0.6000000000000001, 74)
    @field5 = FieldEntry.new(0.75, 149)
    @field6 = FieldEntry.new(0.195, 39)
    @field7 = FieldEntry.new(0.3, 123)
  end

  it 'should multiply relatedness fields' do
    field_one = FieldEntry.new(0.3, 85)
    field_two = FieldEntry.new(0.09, 123)
